...
public struct DistrictType
{
    ...
    [Min(1)] public int minNumberOfPlacements; // N‰chster Schritt, miteinbeziehen
    [Min(1)] public int maxNumberOfPlacements; // N‰chster Schritt, miteinbeziehen
    ...
    public List<GameObject> buildingTypes; // N‰chster Schritt, miteinbeziehen
    public int minLotSizeSquared; // N‰chster Schritt, miteinbeziehen
}
